...
if (isset($_POST["submitcart"])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO orderscart (farmer_id,order_type, pickup_location, delivery_location, goods_type, goods_weight, total_price, payment_status) VALUES (?,?, ?, ?, ?, ?, ?, ?)";
        ...
        if (mysqli_stmt_prepare($stmt, $sql)) {
            ...
            mysqli_close($conn);
            echo "<div class='alert alert-success'>Order added to cart successfully.</div>";
