...
require views_path("employeeOtherviews/mainindex/indexconstantnavview");?>
<div class="container-fluid border col-lg-5 col-md-6 pt-2 bg-light  myclassmargintop" >
<?php
require "../app/core/employeecores/logintosytem.php";

?>       
<form action="?page_name=login" method="post">
            <h3><i class="fa fa-user"></i>employee login</h3>
            <br>
